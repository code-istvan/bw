      ...
      content: (
        <div className="mt-40px">
          ...
          <p>
            ...
            leckéket nem kaptak. Ennek egyik oka az, hogy az amavaszja (újhold)
            és a púrnima (telihold) napokon bizonyos rituálékat kellett a
            tanároknak és a diákoknak végrehajtaniuk, akik mindannyian brahminok
            voltak. Ilyen rituálé például a pitri tarpana újhold napján, vagy a
            holdnapokat követő napon végzendő rituális fürdő. Ezek a
            szertartások meglehetősen időigényesek. Ezen kívül – bár én soha nem
            találtam erre utalást – Pattabhi Jois gyakran idézte (és a mysore-i
            Bhagavad Gíta tanárom, Naranacharya Professzor is említette), hogy
            ha egy tanár holdnapokon újat tanít, akkor csökken a tudása. A
            holdnapot megelőző és követő napokon pedig a diák tudása csökken.
          </p>
          <br />
          <p>
            Amikor beszéltem Pattabhi Jois asztrológusával a Guruji könyvben
            lévő interjú készítésekor, ő is egyetértett azzal, hogy ez a szokás
            azt a védikus elképzelést tükrözi, miszerint az elménk olyan, mint a
            hold. „Amint fent, úgy lent”: növekszik, csökken, és ugyanazon
            ciklusok szerint tárolja az információt, ahogy a Hold is változik,
            mivel a Hold hatással van a Föld gravitációjára.
          </p>
          <br />
          <p>
            Mivel Pattabhi Jois a Maharádzsa Pathasálájának tanulója volt, majd
            a főiskola jógaprofesszora lett 1937 és 1973 között, ezért a
            ...
            pránájáma és az ászana az Upanisadok megértéséhez vezető út kapuja,
            ezért a jóga tanítására is ugyanazokat a szabályokat vonatkoztatta,
            mint a Védák oktatására.
          </p>
          <br />
          <p>
            Továbbá azt is mondta, hogy a holdnapokon könnyebb megsérülni, és a
            sérülések maguk is lassabban gyógyulnak. Személy szerint ezt sosem
            tudtam alátámasztani a dzsjótis (védikus asztrológia) alapján. Talán
            ez is olyasvalami, amit az édesapjától tanult, aki kiváló
            asztrológus volt. Patthabhi maga is értett az asztrológiához – a
            neve, Jois, a dzsjótis (asztrológus) szó dél-indiai torzítása, tehát
            az asztrológia a családi hagyományuk része volt.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            vonatkozó szabályokat, ha lehetőségük van rá. Mindennek az a célja,
            hogy kapcsolódjunk a tanítói láncolathoz, illetve alázatot,
            ...
            de akik mégis ezt teszik, azok testének jól jön egy extra pihenőnap.
          </p>
          <br />
          <p>
            Van egy sajátos bája annak, ha meghódolunk egy láncolat előtt, és ez
            hatással van a személyiségünkre, tehát miért ne próbálnánk meg? Nem
            hiszem, hogy minden jógagyakorlónak szigorúan pihenőnapot kellene
            tartania ezeken a napokon – mindenki kövesse a saját tanárát, és
            remélhetőleg, ha magasabb elvekhez hangoljuk az elménket, akkor
            boldogságot találunk a gyakorlásunkban. Holdnapokon és azokon túl!
          </p>
          <br />
          <p>
    ...
    },
    {
      ...
      content: (
        <div className="mt-40px">
          ...
          <br />
          <p>
            Az Ekadashi a hindu kultúra böjtnapja. A szó maga szanszkrit nyelven
            “tizenegyedik”-et jelent, és a holdtöltét, valamint újholdat követő
            tizenegyedik napra vonatkozik. A védikus hagyományok szerint - a
            Hold aktuális állásának köszönhetően -, testünk és elménk ezeken a
            napokon a legalkalmasabb a megtisztulásra. A böjt segítségével
            fizikai testünk megpihen. Üres, könnyű és tiszta gyomorral tudatunk
            energetikusabb és éberebb működésre képes. Ezeket a napokat érdemes
            befelé fordulással, spirituális gyakorlással tölteni (mantrázás,
            meditálás).
          </p>
        </div>
      ),
